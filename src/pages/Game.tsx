...
export const Game = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--tg-bg-black)] text-white px-4 pb-20">
      ...
      {/* Tabs */}
      <NavbarTabs tabs={TABS} activeTab={activeTab} onTabClick={setActiveTab} className="mb-6" />

      {/* Content based on active tab */}
      {activeTab === 'lootboxes' && (
        <LootboxGrid lootboxes={LOOTBOXES} onLootboxClick={handleLootboxClick} className="mb-8" />
      )}

      {activeTab === 'assets' && (
        <div className="text-center text-gray-400 py-12">Assets content coming soon...</div>
      )}
